...
public class MaxNoPersons {

    //A party has been organised on cruise. The party is organised for a limited time (T). 
    // The number of guests entering (E[i]) and leaving (L[i]) the party at every hour is represented 
    // as elements of the array. The task is to find the maximum number of guests present on the cruise 
